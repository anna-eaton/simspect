...
fun o_p[p: PTag->univ] : Operand {i_p[p].operands :> (Operand - p[RO])} // good operands, remove ops and also ones that touch removed instructions
...
fun leakage_function_p[p: PTag->univ] : Operand {leakage_function - p[RO]}
