...
def _kind_token(ins: str, inst: AlloyInstance) -> str:
    if ins in inst.sig_atoms.get("this/Load", set()):
        return "ld"
    if ins in inst.sig_atoms.get("this/Store", set()):
        return "str"
    if ins in inst.sig_atoms.get("this/Branchn", set()):
        return "br_n"
    if ins in inst.sig_atoms.get("this/Branchx", set()):
        return "br_x"
    if ins in inst.sig_atoms.get("this/Othern", set()):
        return "other_n"
    if ins in inst.sig_atoms.get("this/Otherx", set()):
        return "other_x"
    return "unknown"
